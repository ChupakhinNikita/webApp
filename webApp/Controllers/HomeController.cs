    ...
    public class HomeController : Controller
    {
        ...
        public async Task<IActionResult> RecordBook()
        {
            ...
            try
            {
                ...
                List<RecordBook> books = new List<RecordBook>();

                for (int i = 0; i < count; i++)
                {
                    RecordBook? bookData = JsonConvert.DeserializeObject<RecordBook?>(recordBookData.Result.JsonRecord[i].ToJson());
                    books.Add(bookData);
                }
        ...
        public async Task<IActionResult> Orders()
        {
            ...
            try
            {
                ...
                for (int i = 0; i < count; i++) {
                    Orders orderd = JsonConvert.DeserializeObject<Orders>(ordersData.Result.JsonRecord[i].ToJson());
                    orders.Add(orderd);
                }
